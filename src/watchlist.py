...
class WatchList:
    ...
    def watchlists(self):
        ...
        """
        r = requests.get(self.url + "/watchlists",
            params = {},
    ...
    def getwatchlist(self, watchListId):
        ...
        """
        r = requests.get(self.url + f"/watchlists/{watchListId}"
            params = {},
            headers = self._headers())
        return r.json()
    ...
    def create(self, watchListName, symbols):
        ...
        r = requests.post(self.url + "/watchlists",
    ...
    def update(self, watchListId, watchListName, symbols):
        ...
        """
        r = requests.put(self.url + f"/watchlists/{watchListId}",
            params={'name': watchListName, 'symbols':",".join(symbols)},
            headers = self._headers())
        return r.json()
    ...
    def delete(self, watchListId):
        ...
        """
        r = requests.delete(self.url + f"/watchlists/{watchlist_id}" ,
            params = {},
            headers = self._headers())
        return r.json()
    ...
    def addSymbol(self, watchListId, symbols):
        ...
        """
        r = requests.post(self.url + f"watchlists/{watchlist_id}/symbols",
    ...
    def remove(self, watchListId, symbol):
        ...
        """
        r = requests.delete(self.url + f"/watchlists/{watchlist_id}/symbols/{symbol}",
            params = {},
            headers = self._headers())
        return r.json()
