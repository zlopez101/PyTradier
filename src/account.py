...
class Account:
    ...
    def get(self, url, **kwargs):
        """
        Base method for interacting with Tradier
        """
        return requests.get(
            self.url + url, params=kwargs, headers=self._headers()
        ).json()
    ...
    def account(self):
        ...
        """
        return self.get("user/profile")["profile"]
    ...
    def balance(self):
        ...
        """
        return self.get(f"accounts/{self.accountId}/balances")
